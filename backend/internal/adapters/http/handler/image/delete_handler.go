...
// DeleteImageHandler maneja la eliminación de imágenes
type DeleteImageHandler struct {
	useCase *imageuc.DeleteImageUseCase
}

// NewDeleteImageHandler crea una nueva instancia
func NewDeleteImageHandler(useCase *imageuc.DeleteImageUseCase) *DeleteImageHandler {
...
func (h *DeleteImageHandler) Handle(c *gin.Context) {
	...
	// 4. Ejecutar use case
	input := &imageuc.DeleteImageInput{
		ImageID:  imageID,
		RaffleID: raffleID,
		UserID:   userID.(int64),
	}
